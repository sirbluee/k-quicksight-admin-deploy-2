...
export default function SidebarAdmin(){
    ...
    return(
        <div className="fixed top-0 left-0 z-40 h-screen shadow-md transition-transform -translate-x-full sm:translate-x-0 p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
            <div className="flex items-center p-2 space-x-4">
                <Image unoptimized width={50} height={50} src="/assets/teams/phearum.png" alt="amdin profile" className="w-14 h-14 rounded-full dark:bg-gray-500" />
                <div>
                    <h2 className="text-lg font-semibold">Sirblue</h2>
