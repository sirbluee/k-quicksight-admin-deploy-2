...
export default function SidebarAdmin(){
    ...
    return(
        <div className="fixed top-0 left-0 z-40 h-screen transition-transform -translate-x-full sm:translate-x-0 p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
